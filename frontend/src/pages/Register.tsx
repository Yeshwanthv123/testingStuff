  ...
  return (
    <div className="flex min-h-screen w-screen items-center justify-center bg-white font-sans">
      <div className="w-full max-w-md rounded-lg border border-gray-200 p-8 shadow-sm">
        <h2 className="mb-6 text-center text-3xl font-bold text-black">Create Account</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/login" className="inline-block align-baseline text-sm font-bold text-black hover:underline">

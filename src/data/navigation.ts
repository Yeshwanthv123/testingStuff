...
export const navigationItems: NavigationItem[] = [
  {
    id: 'home',
    label: 'Home',
    className: "text-black text-[12.25px] font-medium bg-transparent block leading-[17.5px] outline-[oklab(0.708_0_0_/_0.5)] text-center mr-[21px] pt-0 pb-[3.5px] px-0 border-t-0 border-x-0 border-solid md:text-[15.75px] md:leading-[24.5px] md:mr-[42px]"
  },
  {
    id: 'about',
    label: 'About',

// placeholder for ImpactSection.tsx
import React from 'react';
import { impactData } from '../data/impact';

export function ImpactSection() {
  return (
    <div className="box-border outline-[oklab(0.708_0_0_/_0.5)] py-14 md:py-[84px]">
      <div className="box-border max-w-[1008px] outline-[oklab(0.708_0_0_/_0.5)] mx-auto px-3.5 md:px-[21px]">
        ...
        <div className="items-center box-border gap-x-7 grid grid-cols-none outline-[oklab(0.708_0_0_/_0.5)] gap-y-7 md:gap-x-14 md:grid-cols-[repeat(2,minmax(0px,1fr))] md:gap-y-14">
          {impactData.map((impact) => (
            <div key={impact.id} className="box-border outline-[oklab(0.708_0_0_/_0.5)]">
              <div className="box-border outline-[oklab(0.708_0_0_/_0.5)] mb-[35px] md:mb-[42px]">
                <h3 className="text-[21px] font-bold box-border leading-7 outline-[oklab(0.708_0_0_/_0.5)] mb-3.5 md:mb-[21px]">{impact.title}</h3>
                <p className="text-[oklch(0.373_0.034_259.733)] text-[15.75px] box-border leading-[25.5938px] outline-[oklab(0.708_0_0_/_0.5)]">{impact.description}</p>
              </div>
            </div>
          ))}
        </div>

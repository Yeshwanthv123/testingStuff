...
export function JoinSection() {
  ...
  return (
    <section data-section="join" className="text-black bg-white box-border min-h-[1000px] outline-[oklab(0.708_0_0_/_0.5)]">
            ...
            <form className="box-border outline-[oklab(0.708_0_0_/_0.5)] mb-[21px]" onSubmit={handleSubmit}>
              <div className="box-border outline-[oklab(0.708_0_0_/_0.5)] mb-3.5">
                <input
                  ...
                  className="text-sm bg-[oklch(0.985_0.002_247.839)] box-border flex h-[31.5px] leading-[21px] outline-[oklab(0.708_0_0_/_0.5)] w-full px-3.5 py-[10.5px] rounded-[6.75px] border-solid border-[oklch(0.928_0.006_264.531)] md:text-[12.25px] md:leading-[17.5px]"
                />
              </div>
              <button type="submit" className="text-white font-medium items-center bg-black gap-x-[7px] inline-flex shrink-0 h-[31.5px] justify-center outline-[oklab(0.708_0_0_/_0.5)] gap-y-[7px] text-center text-nowrap w-full px-3.5 py-[10.5px] rounded-[6.75px]">
                Get Started
              </button>
            </form>
            <div className="box-border outline-[oklab(0.708_0_0_/_0.5)] text-center">
